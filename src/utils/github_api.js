...
export const getAccessToken = code => axios.request({
  method: 'POST',
...
export const getInstallationRepos = (tokenType, token, installationId) => axios.request({
  method: 'GET',
...
export const getInstallations = (tokenType, token) => axios.request({
  method: 'GET',
  baseURL: GITHUB_API_URL,
